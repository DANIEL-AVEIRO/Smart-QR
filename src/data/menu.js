...
const itemsByCategory = {
  burgers: [
    { name: 'Classic Smash', price: 8.5, desc: 'Double patty, American cheese, pickles, house sauce' },
    { name: 'BBQ Bacon Stack', price: 11.0, desc: 'Smoked bacon, cheddar, onion jam, BBQ glaze' },
    { name: 'Mushroom Swiss', price: 10.5, desc: 'Sautéed mushrooms, Swiss, garlic aioli' },
    { name: 'Spicy Jalapeño', price: 10.0, desc: 'Pepper jack, jalapeños, chipotle mayo' },
    { name: 'Truffle Burger', price: 13.5, desc: 'Truffle mayo, arugula, aged Gruyère' },
    { name: 'Blue Cheese Bite', price: 11.5, desc: 'Blue cheese crumble, caramelized onion' },
    { name: 'Avocado Ranch', price: 10.5, desc: 'Fresh avocado, ranch, tomato, lettuce' },
    { name: 'Kimchi Crunch', price: 11.0, desc: 'Kimchi slaw, gochujang mayo, sesame' },
    { name: 'Sunrise Burger', price: 12.0, desc: 'Fried egg, bacon, cheddar, hash crisp' },
    { name: 'Veggie Garden', price: 9.5, desc: 'Black bean patty, roasted peppers, herb yogurt' },
  ],
  pizza: [
    { name: 'Margherita', price: 12.0, desc: 'San Marzano tomato, mozzarella, basil' },
    { name: 'Pepperoni Heat', price: 14.0, desc: 'Cup pepperoni, chili oil, mozzarella' },
    { name: 'Four Cheese', price: 13.5, desc: 'Mozzarella, fontina, Parmesan, gorgonzola' },
    { name: 'Funghi Forest', price: 14.5, desc: 'Wild mushrooms, thyme, garlic cream' },
    { name: 'Prosciutto Pear', price: 15.5, desc: 'Prosciutto, pear, honey, arugula' },
    { name: 'BBQ Chicken', price: 14.0, desc: 'Smoked chicken, red onion, BBQ base' },
    { name: 'Diavola', price: 13.5, desc: 'Spicy salami, chili flakes, olive oil' },
    { name: 'Pesto Caprese', price: 13.0, desc: 'Basil pesto, cherry tomato, burrata' },
    { name: 'Seafood Marinara', price: 16.0, desc: 'Prawns, mussels, garlic tomato sauce' },
    { name: 'Truffle Bianca', price: 15.0, desc: 'White sauce, mushrooms, truffle oil' },
  ],
  pasta: [
    { name: 'Spaghetti Carbonara', price: 13.5, desc: 'Guanciale, egg yolk, Pecorino, black pepper' },
    { name: 'Penne Arrabbiata', price: 11.5, desc: 'Spicy tomato, garlic, chili, parsley' },
    { name: 'Fettuccine Alfredo', price: 12.5, desc: 'Butter, cream, Parmesan, nutmeg' },
    { name: 'Pesto Genovese', price: 12.0, desc: 'Basil pesto, pine nuts, green beans' },
    { name: 'Bolognese Tagliatelle', price: 14.0, desc: 'Slow beef ragù over fresh tagliatelle' },
    { name: 'Shrimp Aglio Olio', price: 15.0, desc: 'Garlic oil, chili, prawns, parsley' },
    { name: 'Mushroom Risotto', price: 14.5, desc: 'Arborio rice, porcini, Parmesan' },
    { name: 'Lasagna Classica', price: 14.0, desc: 'Layered pasta, beef, béchamel, cheese' },
    { name: 'Cacio e Pepe', price: 12.0, desc: 'Pecorino, cracked pepper, butter finish' },
    { name: 'Lobster Linguine', price: 18.5, desc: 'Lobster, cherry tomato, white wine sauce' },
  ],
  salads: [
    { name: 'Garden Crunch', price: 9.0, desc: 'Mixed greens, cucumber, radish, lemon vinaigrette' },
    { name: 'Caesar Classic', price: 10.0, desc: 'Romaine, Parmesan, croutons, anchovy dressing' },
    { name: 'Greek Village', price: 10.5, desc: 'Tomato, cucumber, feta, olives, oregano' },
    { name: 'Quinoa Bowl', price: 11.5, desc: 'Quinoa, chickpeas, avocado, tahini' },
    { name: 'Beet & Goat', price: 11.0, desc: 'Roasted beets, goat cheese, walnuts' },
    { name: 'Cobb Plate', price: 12.5, desc: 'Chicken, egg, bacon, blue cheese, avocado' },
    { name: 'Asian Sesame', price: 11.0, desc: 'Napa cabbage, edamame, sesame ginger' },
    { name: 'Caprese Fresh', price: 10.5, desc: 'Tomato, mozzarella, basil, balsamic' },
    { name: 'Kale Super', price: 10.0, desc: 'Massaged kale, apple, sunflower seeds' },
    { name: 'Salmon Niçoise', price: 14.5, desc: 'Seared salmon, egg, beans, olives' },
  ],
  seafood: [
    { name: 'Grilled Salmon', price: 18.0, desc: 'Lemon butter, dill, charred lemon' },
    { name: 'Garlic Butter Prawns', price: 16.5, desc: 'Tiger prawns, garlic, parsley bread' },
    { name: 'Fish & Chips', price: 14.0, desc: 'Beer-battered cod, tartar, fries' },
    { name: 'Lobster Roll', price: 19.5, desc: 'Chilled lobster, herb mayo, toasted bun' },
    { name: 'Seared Scallops', price: 18.5, desc: 'Brown butter, cauliflower purée' },
    { name: 'Miso Cod', price: 17.5, desc: 'Black cod, miso glaze, sesame greens' },
    { name: 'Calamari Fritti', price: 12.0, desc: 'Crispy squid, lemon aioli' },
    { name: 'Tuna Tataki', price: 15.5, desc: 'Seared tuna, ponzu, sesame' },
    { name: 'Seafood Paella', price: 19.0, desc: 'Saffron rice, mussels, prawns, chorizo' },
    { name: 'Clam Linguine', price: 16.0, desc: 'Littleneck clams, white wine, garlic' },
  ],
  grilled: [
    { name: 'Ribeye Steak', price: 28.0, desc: '12oz ribeye, herb butter, sea salt' },
    { name: 'Filet Mignon', price: 32.0, desc: 'Center cut, red wine jus, asparagus' },
    { name: 'BBQ Short Ribs', price: 22.0, desc: 'Slow braised, sticky glaze, pickles' },
    { name: 'Lamb Chops', price: 26.0, desc: 'Rosemary garlic, mint yogurt' },
    { name: 'Chicken Thighs', price: 14.5, desc: 'Charred thighs, chili honey' },
    { name: 'Pork Chop', price: 18.0, desc: 'Bone-in chop, apple mustard' },
    { name: 'Mixed Grill', price: 24.0, desc: 'Steak, chicken, sausage, peppers' },
    { name: 'Skirt Steak', price: 21.0, desc: 'Chimichurri, grilled onion' },
    { name: 'Tomahawk Share', price: 58.0, desc: 'For two, smoked salt, bone marrow butter' },
    { name: 'Grilled Veg Plate', price: 13.0, desc: 'Seasonal veg, romesco, herbs' },
  ],
  sushi: [
    { name: 'Salmon Nigiri', price: 8.0, desc: 'Four pieces, wasabi, soy' },
    { name: 'Tuna Roll', price: 9.5, desc: 'Maguro, nori, sushi rice' },
    { name: 'Dragon Roll', price: 14.0, desc: 'Eel, avocado, cucumber, eel sauce' },
    { name: 'Spicy Tuna', price: 11.0, desc: 'Spicy mayo, scallion, sesame' },
    { name: 'Rainbow Roll', price: 13.5, desc: 'Assorted fish over California roll' },
    { name: 'Shrimp Tempura Roll', price: 12.0, desc: 'Crispy shrimp, avocado, spicy mayo' },
    { name: 'Yellowtail Jalapeño', price: 12.5, desc: 'Hamachi, jalapeño, ponzu' },
    { name: 'Sashimi Platter', price: 22.0, desc: 'Chef’s selection, 12 pieces' },
    { name: 'Veggie Maki', price: 8.5, desc: 'Cucumber, avocado, pickled radish' },
    { name: 'Uni Special', price: 18.0, desc: 'Sea urchin, nori, quail egg' },
  ],
  desserts: [
    { name: 'Chocolate Lava', price: 8.5, desc: 'Warm cake, molten center, vanilla ice cream' },
    { name: 'Berry Cheesecake', price: 8.0, desc: 'New York style, berry compote' },
    { name: 'Tiramisu', price: 8.5, desc: 'Espresso-soaked ladyfingers, mascarpone' },
    { name: 'Crème Brûlée', price: 7.5, desc: 'Vanilla custard, caramelized sugar' },
    { name: 'Apple Tart', price: 7.5, desc: 'Buttery pastry, cinnamon apples' },
    { name: 'Matcha Panna Cotta', price: 7.0, desc: 'Silky matcha cream, white chocolate' },
    { name: 'Churros Plate', price: 7.0, desc: 'Cinnamon sugar, chocolate dip' },
    { name: 'Lemon Tart', price: 7.5, desc: 'Citrus curd, torched meringue' },
    { name: 'Ice Cream Trio', price: 6.5, desc: 'Three scoops, rotating flavors' },
    { name: 'Brownie Sundae', price: 8.0, desc: 'Warm brownie, fudge, whipped cream' },
  ],
  drinks: [
    { name: 'Espresso', price: 3.0, desc: 'Double shot, rich crema' },
    { name: 'Iced Latte', price: 4.5, desc: 'Espresso, cold milk, over ice' },
    { name: 'Fresh Lemonade', price: 4.0, desc: 'House-squeezed, lightly sweet' },
    { name: 'Mango Smoothie', price: 5.5, desc: 'Mango, yogurt, honey' },
    { name: 'Matcha Latte', price: 5.0, desc: 'Ceremonial grade, steamed milk' },
  ...
  breakfast: [
    { name: 'Eggs Benedict', price: 12.5, desc: 'Poached eggs, hollandaise, English muffin' },
    { name: 'Avocado Toast', price: 10.0, desc: 'Sourdough, smashed avocado, chili flake' },
    { name: 'Fluffy Pancakes', price: 9.5, desc: 'Stack of three, maple, butter' },
    { name: 'French Toast', price: 10.0, desc: 'Brioche, berry syrup, cream' },
    { name: 'Breakfast Burrito', price: 11.0, desc: 'Eggs, potato, cheese, salsa' },
    { name: 'Shakshuka', price: 11.5, desc: 'Tomato pepper stew, baked eggs' },
    { name: 'Granola Bowl', price: 8.5, desc: 'Yogurt, granola, seasonal fruit' },
    { name: 'Smokehouse Plate', price: 13.5, desc: 'Eggs, bacon, sausage, toast' },
    { name: 'Croissant Sandwich', price: 9.0, desc: 'Egg, cheese, ham on butter croissant' },
