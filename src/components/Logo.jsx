  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-2 sm:gap-2.5">
        <span className="grid size-12 place-items-center rounded-full bg-ink text-citrus shadow-[0_10px_28px_rgba(26,17,19,0.22)] sm:size-14 md:size-16">
          <QrCode className="size-6 sm:size-7 md:size-8" strokeWidth={2.25} />
        </span>
        <span className="text-[10px] font-semibold uppercase tracking-[0.22em] text-smoke sm:text-[11px]">
          QR System
        </span>
